...
// GetPage Возвращает отрендереную из md в html страницу файл
func (worker MdWorkerImpl) GetPage(path string, title string) string {
	return convertMarkdownToHtml(path, title)
}
